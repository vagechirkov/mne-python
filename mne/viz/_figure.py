...
from .ica import (_create_properties_layout, plot_ica_properties,
                  _prepare_data_plot_ica_properties)
...
class MNEBrowseFigure(MNEFigure):
    ...
    def _create_ica_properties_fig(self, idx):
        ...
        if not hasattr(self, 'data_ica_properties'):
            self.data_ica_properties = _prepare_data_plot_ica_properties(
